      ...
      <div className="flex items-center space-x-3 py-3">
        ...
        <div className="flex items-center space-x-2">
          <Button
            variant="outline"
            size="icon"
            className="h-6 w-6 bg-gray-800 border-gray-600 text-white hover:bg-gray-700"
      ...
      <CardContent className="p-4">
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1 space-y-2">
            <h3 className="font-semibold text-balance text-white">{item.name}</h3>
            <p className="text-lg font-bold text-primary">${item.price}</p>

            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <Button variant="outline" size="icon" className="bg-gray-800 border-gray-600 text-white hover:bg-gray-700" onClick={() => handleQuantityChange(item.quantity - 1)}>
